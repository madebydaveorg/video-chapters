/**
 * Video Chapters v1.0.0 – lightweight runtime
...
;(function (root) {
  ...
  function injectionCSS(cfg) {
    ...
    return '.course-item{overflow:visible!important}'
      ...
      + '.vcb-injected-wrap{display:flex;justify-content:flex-end;padding:6px 16px 0 0;position:relative;z-index:999999!important}'
