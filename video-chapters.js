...
;(function (root) {
  ...
  function injectionCSS(cfg) {
    ...
    return '.course-item{overflow:visible!important}'
      ...
      + '@media(max-width:480px){.course-item{gap:0!important}.course-item__video-container{margin-bottom:0!important;padding-bottom:0!important}.course-item__lesson-content{padding-top:0!important}.vcb-injected-wrap{margin-top:-8px;padding:4px 12px 0 0}}';
  }
  ...
  function wirePopup(container, cfg) {
    ...
    document.addEventListener('click', function (e) {
      if (popup.classList.contains('open') && !container.querySelector('.vcp-wrap').contains(e.target) && e.target !== backdrop) {
        closePopup();
      }
    });
